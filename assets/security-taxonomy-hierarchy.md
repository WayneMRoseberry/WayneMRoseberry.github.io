...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/21.html)

**ATTACK:** Access Token Manipulation, Steal Application Access Token, Steal Web Session Cookie

**Child Attack Patterns:**

  ### CAPEC-62: Cross Site Request Forgery

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/62.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/467.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/196.html)
  ...
  **ATTACK:** Access Token Manipulation: Create Process with Token, Access Token Manipulation: Make and Impersonate Token, Forge Web Credentials

  **Child Attack Patterns:**

    #### CAPEC-59: Session Credential Falsification through Prediction

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/59.html)

    This attack targets predictable session ID in order to gain privileges. The attacker can predict the session ID used during a transaction to perform spoofing and session hijacking.

    **OWASP Attacks:** Session Prediction
    **WASC:** Credential/Session Prediction

    #### CAPEC-226: Session Credential Falsification through Manipulation

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/226.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/510.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/593.html)

  This type of attack involves an adversary that exploits weaknesses in an application's use of sessions in performing authentication. The adversary is able to steal or manipulate an active session and use it to gain unathorized access to the application.

  **ATTACK:** Browser Session Hijacking, Remote Service Session Hijacking, Use Alternate Authentication Material:Application Access Token
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/60.html)

    This attack targets the reuse of valid session ID to spoof the target system in order to gain privileges. The attacker tries to reuse a stolen session ID used previously during a transaction to perform spoofing and session hijacking. Another name for this type of attack is Session Replay.

    **ATTACK:** Access Token Manipulation:Token Impersonation/Theft, Use Alternate Authentication Material:Web Session Cookie

    #### CAPEC-61: Session Fixation

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/61.html)
    ...
    **WASC:** Session Fixation
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/102.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/107.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/22.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/39.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/31.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/77.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/13.html)

    The adversary directly or indirectly modifies environment variables used by or controlling the target software. The adversary's goal is to cause the target software to deviate from its expected operation in a manner that benefits the adversary.

    **ATTACK:** Hijack Execution Flow:Dynamic Linker Hijacking, Hijack Execution Flow:Path Interception by PATH Environment Variable, Impair Defenses:Impair Command History Logging

    #### CAPEC-162: Manipulating Hidden Fields

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/162.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/202.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/207.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/200.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/208.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/25.html)

The adversary triggers and exploits a deadlock condition in the target software to cause a denial of service. A deadlock can occur when two or more competing actions are waiting for each other to finish, and thus neither ever does. Deadlock conditions can be difficult to detect.

**ATTACK:** Endpoint Denial of Service: Application or System Exploitation

## CAPEC-26: Leveraging Race Conditions

[Full definition on MITRE](https://capec.mitre.org/data/definitions/26.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/29.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/27.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/28.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/74.html)

**Child Attack Patterns:**

  ### CAPEC-140: Bypassing of Intermediate Forms in Multiple-Form Sets

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/140.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/663.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/696.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/94.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/219.html)
  ...
  **WASC:** Routing Detour, XML Entity Expansion

  ### CAPEC-384: Application API Message Manipulation via Man-in-the-Middle

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/384.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/385.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/389.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/386.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/387.html)

    An adversary manipulates either egress or ingress data from a client within an application framework in order to change the content of messages and thereby circumvent the expected application logic.

    #### CAPEC-388: Application API Button Hijacking

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/388.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/466.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/662.html)
  ...
  **OWASP Attacks:** Man-in-the-browser attack
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/701.html)

  An adversary exploits the inherent functionalities of a web browser, in order to establish an unnoticed remote desktop connection in the victim's browser to the adversary's system. The adversary must deploy a web client with a remote desktop session that the victim can access.

## CAPEC-112: Brute Force

[Full definition on MITRE](https://capec.mitre.org/data/definitions/112.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/20.html)

  An attacker, armed with the cipher text and the encryption algorithm used, performs an exhaustive (brute force) search on the key space to determine the key that decrypts the cipher text to obtain the plaintext.

  ### CAPEC-49: Password Brute Forcing

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/49.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/16.html)

    #### CAPEC-55: Rainbow Table Password Cracking

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/55.html)
    ...
    **ATTACK:** Brute Force:Password Cracking
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/70.html)
    ...
    **ATTACK:** Valid Accounts:Default Accounts
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/565.html)

    **ATTACK:** Brute Force:Password Spraying

## CAPEC-113: Interface Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/113.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/36.html)

  An adversary searches for and invokes interfaces or functionality that the target system designers did not intend to be publicly available. If interfaces fail to authenticate requests, the attacker may be able to invoke functionality they are not authorized for.

  ### CAPEC-121: Exploit Non-Production Interfaces

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/121.html)

  **Child Attack Patterns:**

    #### CAPEC-661: Root/Jailbreak Detection Evasion via Debugging

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/661.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/133.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/160.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/114.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/115.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/87.html)
  ...
  **WASC:** Predictable Resource Location
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/461.html)

  An adversary utilizes a hash function extension/padding weakness, to modify the parameters passed to the web service requesting authentication by generating their own call in order to generate a legitimate signature hash (as described in the notes), without knowledge of the secret token sometimes provided by the web service.

  ### CAPEC-480: Escaping Virtualization

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/480.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/237.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/664.html)

  ### CAPEC-668: Key Negotiation of Bluetooth Attack (KNOB)

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/668.html)

  An adversary can exploit a flaw in Bluetooth key negotiation allowing them to decrypt information sent between two devices communicating via Bluetooth. The adversary uses an Adversary in the Middle setup to modify packets sent between the two devices during the authentication process, specifically the entropy bits. Knowledge of the number of entropy bits will allow the attacker to easily decrypt information passing over the line of communication.

  **ATTACK:** Data Manipulation: Transmitted Data Manipulation

## CAPEC-116: Excavation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/116.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/54.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/95.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/127.html)
    ...
    **ATTACK:** File and Directory Discovery
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/215.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/261.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/462.html)

    An attacker initiates cross domain HTTP / GET requests and times the server responses. The timing of these responses may leak important information on what is happening on the server. Browser's same origin policy prevents the attacker from directly reading the server responses (in the absence of any other weaknesses), but does not prevent the attacker from timing the responses to requests that the attacker issued cross domain.

  ### CAPEC-150: Collect Data from Common Resource Locations

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/150.html)
  ...
  **ATTACK:** Automated Collection, Credentials from Password Stores, Data from Cloud Storage Object, Data from Configuration Repository, Data from Information Repositories, OS Credential Dumping

  **Child Attack Patterns:**

    #### CAPEC-143: Detect Unpublicized Web Pages

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/143.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/144.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/155.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/406.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/637.html)
    ...
    **ATTACK:** Clipboard Data
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/647.html)

    An adversary exploits a weakness in authorization to gather system-specific data and sensitive information within a registry (e.g., Windows Registry, Mac plist). These contain information about the system configuration, software, operating system, and security. The adversary can leverage information gathered in order to carry out further attacks.

    **ATTACK:** Data from Local System, Query Registry, Unsecured Credentials: Credentials in Registry

    #### CAPEC-648: Collect Data from Screen Capture

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/648.html)
    ...
    **ATTACK:** Screen Capture, Screen Capture

  ### CAPEC-545: Pull Data from System Resources

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/545.html)
  ...
  **ATTACK:** Credentials from Password Stores:Keychain, Data from Local System

  **Child Attack Patterns:**

    #### CAPEC-498: Probe iOS Screenshots

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/498.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/546.html)

    An adversary obtains unauthorized information due to insecure or incomplete data deletion in a multi-tenant environment. If a cloud provider fails to completely delete storage and data from former cloud tenants' systems/resources, once these resources are allocated to new, potentially malicious tenants, the latter can probe the provided resources for sensitive information still there.

    #### CAPEC-639: Probe System Files

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/639.html)

    An adversary obtains unauthorized information due to improperly protected files. If an application stores sensitive information in a file that is not protected by proper access control, then an adversary can access the file and search for sensitive information.

    **ATTACK:** Data from Network Shared Drive, Unsecured Credentials: Bash History, Unsecured Credentials: Credentials in Files, Unsecured Credentials: Group Policy Preferences, Unsecured Credentials: Private Keys

  ### CAPEC-569: Collect Data as Provided by Users

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/569.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/568.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/675.html)

  **ATTACK:** Exfiltration Over Physical Medium

## CAPEC-117: Interception

[Full definition on MITRE](https://capec.mitre.org/data/definitions/117.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/157.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/57.html)
    ...
    **ATTACK:** Network Sniffing
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/65.html)
    ...
    **ATTACK:** Network Sniffing
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/158.html)
    ...
    **ATTACK:** Multi-Factor Authentication Interception, Network Sniffing

    #### CAPEC-609: Cellular Traffic Intercept

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/609.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/499.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/501.html)

    An adversary intercepts an implicit intent sent to launch a Android-based trusted activity and instead launches a counterfeit activity in its place. The malicious activity is then used to mimic the trusted activity's user interface and prompt the target to enter sensitive data as if they were interacting with the trusted activity.

  ### CAPEC-651: Eavesdropping

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/651.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/508.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/634.html)
    ...
    **ATTACK:** Audio Capture, Video Capture

    #### CAPEC-699: Eavesdropping on a Monitor

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/699.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/122.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/1.html)
  ...
  **ATTACK:** Hijack Execution Flow: ServicesFile Permissions Weakness

  **Child Attack Patterns:**

    #### CAPEC-58: Restful Privilege Elevation

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/58.html)

    An adversary identifies a Rest HTTP (Get, Put, Delete) style permission method allowing them to perform various malicious actions upon server data due to lack of access control mechanisms implemented within the application service accepting HTTP messages.

    #### CAPEC-679: Exploitation of Improperly Configured or Implemented Memory Protections

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/679.html)

    #### CAPEC-680: Exploitation of Improperly Controlled Registers

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/680.html)

    #### CAPEC-681: Exploitation of Improperly Controlled Hardware Security Identifiers

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/681.html)

  ### CAPEC-17: Using Malicious Files

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/17.html)

  An attack of this type exploits a system's configuration that allows an adversary to either directly access an executable file, for example through shell access; or in a possible worst case allows an adversary to upload a file and then execute it. Web servers, ftp servers, and message oriented middleware systems which have many integration points are particularly vulnerable, because both the programmers and the administrators must be in synch regarding the interfaces and the correct privileges for each interface.

  **ATTACK:** Hijack Execution Flow: Executable Installer File Permissions Weakness, Hijack Execution Flow: Services File Permissions Weakness

  **Child Attack Patterns:**

    #### CAPEC-177: Create files with the same name as files protected with a higher classification

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/177.html)
    ...
    **ATTACK:** Masquerading
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/263.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/562.html)
    ...
    **ATTACK:** Taint shared content
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/563.html)

    An adversaries may add malicious content to a website through the open file share and then browse to that content with a web browser to cause the server to execute the content. The malicious content will typically run under the context and permissions of the web server process, often resulting in local system or administrative privileges depending on how the web server is configured.

    #### CAPEC-642: Replace Binaries

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/642.html)

    Adversaries know that certain binaries will be regularly executed as part of normal processing. If these binaries are not protected with the appropriate file system permissions, it could be possible to replace them with malware. This malware might be executed at higher system permission levels. A variation of this pattern is to discover self-extracting installation packages that unpack binaries to directories with weak file permissions which it does not clean up appropriately. These binaries can be replaced by malware, which can then be executed.

    **ATTACK:** Compromise Client Software Binary, Hijack Execution Flow:Executable Installer File Permissions Weakness, Server Software Component: Terminal Services DLL
    **OWASP Attacks:** Binary planting

    #### CAPEC-650: Upload a Web Shell to a Web Server

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/650.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/180.html)

  An attacker exploits a weakness in the configuration of access controls and is able to bypass the intended protection that these measures guard against and thereby obtain unauthorized access to the system or network. Sensitive functionality should always be protected with access controls. However configuring all but the most trivial access control systems can be very complicated and there are many opportunities for mistakes. If an attacker can learn of incorrectly configured access security settings, they may be able to exploit this in an attack.

  **ATTACK:** Hijack Execution Flow: Services File Permissions Weaknesses

  **Child Attack Patterns:**

    #### CAPEC-702: Exploiting Incorrect Chaining or Granularity of Hardware Debug Components

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/702.html)

  ### CAPEC-201: Serialized Data External Linking

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/201.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/503.html)

  An adversary, through a malicious web page, accesses application specific functionality by leveraging interfaces registered through WebView's addJavascriptInterface API. Once an interface is registered to WebView through addJavascriptInterface, it becomes global and all pages loaded in the WebView can call this interface.

## CAPEC-123: Buffer Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/123.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/100.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/8.html)

    This attack targets libraries or shared code modules which are vulnerable to buffer overflow attacks. An adversary who has knowledge of known vulnerable libraries or shared code can easily target software that makes use of these libraries. All clients that make use of the code library thus become vulnerable by association. This has a very broad effect on security across a system, usually affecting more than one software process.

    #### CAPEC-9: Buffer Overflow in Local Command-Line Utilities

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/9.html)

    This attack targets command-line utilities available in a number of shells. An adversary can leverage a vulnerability found in a command-line utility to escalate privilege to root.

    #### CAPEC-10: Buffer Overflow via Environment Variables

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/10.html)
    ...
    **OWASP Attacks:** Buffer Overflow via Environment Variables
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/14.html)

    This type of attack exploits a buffer overflow vulnerability in targeted client software through injection of malicious content from a custom-built hostile service. This hostile service is created to deliver the correct content to the client software. For example, if the client-side application is a browser, the service will host a webpage that the browser loads.

    #### CAPEC-24: Filter Failure through Buffer Overflow

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/24.html)

    In this attack, the idea is to cause an active filter to fail by causing an oversized transaction. An attacker may try to feed overly long input strings to the program in an attempt to overwhelm the filter (by causing a buffer overflow) and hoping that the filter does not fail securely (i.e. the user input is let into the system unfiltered).

    #### CAPEC-42: MIME Conversion

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/42.html)

    An attacker exploits a weakness in the MIME conversion routine to cause a buffer overflow and gain control over the mail server machine. The MIME system is designed to allow various different information formats to be interpreted and sent via e-mail. Attack points exist when data are converted to MIME compatible format and back.

    #### CAPEC-44: Overflow Binary Resource File

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/44.html)

    An attack of this type exploits a buffer overflow vulnerability in the handling of binary resources. Binary resources may include music files like MP3, image files like JPEG files, and any other binary file. These attacks may pass unnoticed to the client machine through normal usage of files, such as a browser loading a seemingly innocent JPEG file. This can allow the adversary access to the execution stack and execute arbitrary code in the target process.

    #### CAPEC-45: Buffer Overflow via Symbolic Links

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/45.html)

    This type of attack leverages the use of symbolic links to cause buffer overflows. An adversary can try to create or manipulate a symbolic link file such that its contents result in out of bounds data. When the target software processes the symbolic link file, it could potentially overflow internal buffers with insufficient bounds checking.

    #### CAPEC-46: Overflow Variables and Tags

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/46.html)

    This type of attack leverages the use of tags or variables from a formatted configuration data to cause buffer overflow. The adversary crafts a malicious HTML page or configuration file that includes oversized strings, thus causing an overflow.

    #### CAPEC-47: Buffer Overflow via Parameter Expansion

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/47.html)

    In this attack, the target software is given input that the adversary knows will be modified and expanded in size during processing. This attack relies on the target software failing to anticipate that the expanded data may exceed some internal limit, thereby creating a buffer overflow.

    #### CAPEC-67: String Format Overflow in syslog()

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/67.html)
    ...
    **WASC:** Format String
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/256.html)
    ...
    **WASC:** SOAP Array Abuse

  ### CAPEC-540: Overread Buffers

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/540.html)

  An adversary attacks a target by providing input that causes an application to read beyond the boundary of a defined buffer. This typically occurs when a value influencing where to start or stop reading is set to reflect positions outside of the valid memory location of the buffer. This type of attack may result in exposure of sensitive information, a system crash, or arbitrary code execution.

## CAPEC-124: Shared Resource Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/124.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/125.html)
...
**ATTACK:** Endpoint Denial of Service, Network Denial of Service: Direct Network Flood
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/482.html)

  An adversary may execute a flooding attack using the TCP protocol with the intent to deny legitimate users access to a service. These attacks exploit the weakness within the TCP protocol where there is some state information for the connection the server needs to maintain. This often involves the use of TCP SYN messages.

  **ATTACK:** Endpoint Denial of Service: OS Exhaustion Flood, Endpoint Denial of Service: Service Exhaustion Flood, Network Denial of Service: Direct Network Flood

  ### CAPEC-486: UDP Flood

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/486.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/487.html)

  An adversary may execute a flooding attack using the ICMP protocol with the intent to deny legitimate users access to a service by consuming the available network bandwidth. A typical attack involves a victim server receiving ICMP packets at a high rate from a wide range of source addresses. Additionally, due to the session-less nature of the ICMP protocol, the source of a packet is easily spoofed making it difficult to find the source of the attack.

  ### CAPEC-488: HTTP Flood

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/488.html)

  An adversary may execute a flooding attack using the HTTP protocol with the intent to deny legitimate users access to a service by consuming resources at the application layer such as web services and their infrastructure. These attacks use legitimate session-based HTTP GET requests designed to consume large amounts of a server's resources. Since these are legitimate sessions this attack is very difficult to detect.

  **ATTACK:** Endpoint Denial of Service:Service Exhaustion Flood

  ### CAPEC-489: SSL Flood

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/489.html)
  ...
  **ATTACK:** Endpoint Denial of Service:Service Exhaustion Flood
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/490.html)
  ...
  **ATTACK:** Network Denial of Service:Reflection Amplification

  ### CAPEC-528: XML Flood

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/528.html)

  An adversary may execute a flooding attack using XML messages with the intent to deny legitimate users access to a web service. These attacks are accomplished by sending a large number of XML based requests and letting the service attempt to parse each one. In many cases this type of an attack will result in a XML Denial of Service (XDoS) due to an application becoming unstable, freezing, or crashing.

  **ATTACK:** Endpoint Denial of Service:Service Exhaustion Flood, Network Denial of Service:Direct Network Flood

  **Child Attack Patterns:**

    #### CAPEC-147: XML Ping of the Death

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/147.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/666.html)
  ...
  **ATTACK:** Endpoint Denial of Service: OS Exhaustion Flood, Network Denial of Service: Direct Network Flood

## CAPEC-129: Pointer Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/129.html)

This attack pattern involves an adversary manipulating a pointer within a target application resulting in the application accessing an unintended memory location. This can result in the crashing of the application or, for certain pointer values, access to data that would not normally be possible or the execution of arbitrary code. Since pointers are simply integer variables, Integer Attacks may often be used in Pointer Attacks.

## CAPEC-130: Excessive Allocation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/130.html)
...
**ATTACK:** Endpoint Denial of Service:Application Exhaustion Flood
**WASC:** Denial of Service
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/230.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/197.html)
    ...
    **WASC:** XML Entity Expansion
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/491.html)

    An adversary exploits macro-like substitution to cause a denial of service situation due to excessive memory being allocated to fully expand the data. The result of this denial of service could cause the application to freeze or crash. This involves defining a very large entity and using it multiple times in a single entity substitution. CAPEC-197 is a similar attack pattern, but it is easier to discover and defend against. This attack pattern does not perform multi-level substitution and therefore does not obviously appear to consume extensive resources.

  ### CAPEC-231: Oversized Serialized Data Payloads

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/231.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/221.html)
    ...
    **WASC:** XML External Entities
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/229.html)

    This attack exploits certain serialized data parsers (e.g., XML, YAML, etc.) which manage data in an inefficient manner. The attacker crafts an serialized data file with multiple configuration parameters in the same dataset. In a vulnerable parser, this results in a denial of service condition where CPU resources are exhausted because of the parsing algorithm. The weakness being exploited is tied to parser implementation and not language specific.

    **WASC:** XML Attribute Blowup

  ### CAPEC-492: Regular Expression Exponential Blowup

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/492.html)
  ...
  **OWASP Attacks:** Regular expression Denial of Service - ReDoS
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/493.html)

  An adversary may execute an attack on a web service that uses SOAP messages in communication. By sending a very large SOAP array declaration to the web service, the attacker forces the web service to allocate space for the array elements before they are parsed by the XML parser. The attacker message is typically small in size containing a large array declaration of say 1,000,000 elements and a couple of array elements. This attack targets exhaustion of the memory resources of the web service.

  ### CAPEC-494: TCP Fragmentation

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/494.html)

  An adversary may execute a TCP Fragmentation attack against a target with the intention of avoiding filtering rules of network controls, by attempting to fragment the TCP packet such that the headers flag field is pushed into the second fragment which typically is not filtered.

  ### CAPEC-495: UDP Fragmentation

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/495.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/496.html)

  An attacker may execute a ICMP Fragmentation attack against a target with the intention of consuming resources or causing a crash. The attacker crafts a large number of identical fragmented IP packets containing a portion of a fragmented ICMP message. The attacker these sends these messages to a target host which causes the host to become non-responsive. Another vector may be sending a fragmented ICMP message to a target host with incorrect sizes in the header which causes the host to hang.

## CAPEC-131: Resource Leak Exposure

[Full definition on MITRE](https://capec.mitre.org/data/definitions/131.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/137.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/6.html)

  An attacker changes the behavior or state of a targeted application through injecting data or command syntax through the targets use of non-validated and non-filtered arguments of exposed services or methods.

  ### CAPEC-15: Command Delimiters

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/15.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/460.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/134.html)
  ...
  **WASC:** Mail Command Injection

  ### CAPEC-135: Format String Injection

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/135.html)
  ...
  **OWASP Attacks:** Format string attack
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/138.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/182.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/174.html)

    An adversary takes advantage of improper data validation to inject malicious global parameters into a Flash file embedded within an HTML document. Flash files can leverage user-submitted data to configure the Flash document and access the embedding HTML document.

    #### CAPEC-178: Cross-Site Flashing

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/178.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/148.html)
...
**WASC:** Content Spoofing

**Child Attack Patterns:**

  ### CAPEC-145: Checksum Spoofing

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/145.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/218.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/502.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/627.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/628.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/151.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/89.html)

  A pharming attack occurs when the victim is fooled into entering sensitive data into supposedly trusted locations, such as an online bank site or a trading platform. An attacker can impersonate these supposedly trusted sites and have the victim be directed to their site rather than the originally intended one. Pharming does not require script injection or clicking on malicious links for the attack to succeed.

  ### CAPEC-98: Phishing

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/98.html)
  ...
  **ATTACK:** Phishing, Phishing for Information

  **Child Attack Patterns:**

    #### CAPEC-163: Spear Phishing

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/163.html)
    ...
    **ATTACK:** Internal Spearfishing, Phishing for Information: Spearfishing Attachment, Phishing for Information: Spearfishing Link, Phishing for Information: Spearfishing Service, Phishing: Spearfishing Attachment, Phishing: Spearfishing Link, Phishing: Spearfishing via Service

    #### CAPEC-164: Mobile Phishing

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/164.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/656.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/194.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/275.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/543.html)
    ...
    **ATTACK:** Masquerading: Match Legitimate Name or Location
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/544.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/598.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/633.html)
    ...
    **ATTACK:** Access Token Manipulation
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/697.html)

    **ATTACK:** Adversary-in-the-Middle: DHCP Spoofing

  ### CAPEC-195: Principal Spoof

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/195.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/599.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/473.html)

  An attacker generates a message or datablock that causes the recipient to believe that the message or datablock was generated and cryptographically signed by an authoritative or reputable source, misleading a victim or victim operating system into performing malicious actions.

  **ATTACK:** Masquerading: Invalid Code Signature, Subvert Trust Controls: Code Signing

  **Child Attack Patterns:**

    #### CAPEC-459: Creating a Rogue Certification Authority Certificate

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/459.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/474.html)
    ...
    **ATTACK:** Unsecured Credentials: Private Keys
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/475.html)

    An adversary exploits a cryptographic weakness in the signature verification algorithm implementation to generate a valid signature without knowing the key.

    #### CAPEC-476: Signature Spoofing by Misrepresentation

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/476.html)

    An attacker exploits a weakness in the parsing or display code of the recipient software to generate a data blob containing a supposedly valid signature, but the signer's identity is falsely represented, which can lead to the attacker manipulating the recipient software or its victim user to perform compromising actions.

    #### CAPEC-477: Signature Spoofing by Mixing Signed and Unsigned Content

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/477.html)

    An attacker exploits the underlying complexity of a data structure that allows for both signed and unsigned content, to cause unsigned data to be processed as though it were signed data.

    #### CAPEC-479: Malicious Root Certificate

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/479.html)
    ...
    **ATTACK:** Subvert Trust Controls:Install Root Certificate
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/485.html)

    An attacker obtains an authoritative or reputable signer's private signature key by exploiting a cryptographic weakness in the signature algorithm or pseudorandom number generation and then uses this key to forge signatures from the original signer to mislead a victim into performing actions that benefit the attacker.

    **ATTACK:** Unsecure Credentials: Private Keys

## CAPEC-153: Input Data Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/153.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/126.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/76.html)

    An attacker manipulates inputs to the target software which the target software passes to file system calls in the OS. The goal is to gain access to, and perhaps modify, areas of the file system that the target software did not intend to be accessible.

    #### CAPEC-139: Relative Path Traversal

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/139.html)

    An attacker exploits a weakness in input validation on the target by supplying a specially constructed path utilizing dot and slash characters for the purpose of obtaining access to arbitrary files or resources. An attacker modifies a known path on the target in order to reach material that is not available through intended channels. These attacks normally involve adding additional path separators (/ or \) and/or dots (.), or encodings thereof, in various combinations in order to reach parent directories or entirely separate trees of the target's directory structure.

    #### CAPEC-597: Absolute Path Traversal

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/597.html)

    An adversary with access to file system resources, either directly or via application logic, will use various file absolute paths and navigation mechanisms such as ".." to extend their range of access to inappropriate areas of the file system. The goal of the adversary is to access directories and files that are intended to be restricted from their access.

  ### CAPEC-128: Integer Attacks

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/128.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/92.html)

    This attack forces an integer variable to go out of range. The integer variable is often used as an offset such as size of memory allocation or similarly. The attacker would typically control the value of such variable and try to get it out of range. For instance the integer in question is incremented past the maximum possible value, it may wrap to become a very small, or negative number, therefore providing a very incorrect value which can lead to unexpected behavior. At worst the attacker can execute arbitrary code.

    **WASC:** Integer Overflows

  ### CAPEC-267: Leverage Alternate Encoding

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/267.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/3.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/4.html)

    This attack relies on the adversary using unexpected formats for representing IP addresses. Networked applications may expect network location information in a specific format, such as fully qualified domains names (FQDNs), URL, IP address, or IP Address ranges. If the location information is not validated against a variety of different possible encodings and formats, the adversary can use an alternate format to bypass application access control.

    #### CAPEC-43: Exploiting Multiple Input Interpretation Layers

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/43.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/52.html)
    ...
    **WASC:** Null Byte Injection

    #### CAPEC-53: Postfix, Null Terminate, and Backslash

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/53.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/64.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/71.html)
    ...
    **OWASP Attacks:** Unicode Encoding
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/72.html)

    This attack targets the encoding of the URL. An adversary can take advantage of the multiple way of encoding an URL and abuse the interpretation of the URL.

    #### CAPEC-78: Using Escaped Slashes in Alternate Encoding

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/78.html)

    This attack targets the use of the backslash in alternate encoding. An adversary can provide a backslash as a leading character and causes a parser to believe that the next character is special. This is called an escape. By using that trick, the adversary tries to exploit alternate ways to encode the same character which leads to filter problems and opens avenues to attack.

    #### CAPEC-79: Using Slashes in Alternate Encoding

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/79.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/80.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/120.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/154.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/159.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/38.html)
    ...
    **ATTACK:** Hijack Execution Flow: Path Interception by PATH Environment Variable, Hijack Execution Flow: Path Interception by Unquoted Path

    #### CAPEC-132: Symlink Attack

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/132.html)
    ...
    **ATTACK:** Boot or Logon Autostart Execution:Shortcut Modification
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/471.html)
    ...
    **ATTACK:** Hijack Execution Flow: Dylib Hijacking, Hijack Execution Flow: Path Interception by Search Order Hijacking, Hijack Execution Flow:DLL search order hijacking

    #### CAPEC-641: DLL Side-Loading

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/641.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/616.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/505.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/611.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/615.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/617.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/630.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/631.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/632.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/667.html)

    An adversary disguises the MAC address of their Bluetooth enabled device to one for which there exists an active and trusted connection and authenticates successfully. The adversary can then perform malicious actions on the target Bluetooth device depending on the target’s capabilities.

    #### CAPEC-695: Repo Jacking

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/695.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/161.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/141.html)
  ...
  **ATTACK:** Adversary-in-the-Middle: ARP Cache Poisoning
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/142.html)

    A domain name server translates a domain name (such as www.example.com) into an IP address that Internet hosts use to contact Internet resources. An adversary modifies a public DNS cache to cause certain names to resolve to incorrect addresses that the adversary specifies. The result is that client applications that rely upon the targeted cache for domain name resolution will be directed not to the actual address of the specified domain name but to some other address. Adversaries can use this to herd clients to sites that install malware on the victim's computer or to masquerade as part of a Pharming attack.

    **ATTACK:** Compromise Infrastructure: DNS Server

  ### CAPEC-166: Force the System to Reset Values

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/166.html)

  An attacker forces the target into a previous state in order to leverage potential weaknesses in the target dependent upon a prior configuration or state-dependent factors. Even in cases where an attacker may not be able to directly control the configuration of the targeted application, they may be able to reset the configuration to a prior state since many applications implement reset functions.

  ### CAPEC-268: Audit Log Manipulation

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/268.html)

  The attacker injects, manipulates, deletes, or forges malicious log entries into the log file, in an attempt to mislead an audit of the log file or cover tracks of an attack. Due to either insufficient access controls of the log files or the logging mechanism, the attacker is able to perform such actions.

  **ATTACK:** Impair Defenses: Disable Cloud Logs, Impair Defenses: Disable Windows Event Logging, Impair Defenses: Impair Command History Logging, Indicator Removal on Host
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/81.html)

    Web Logs Tampering attacks involve an attacker injecting, deleting or otherwise tampering with the contents of web logs typically for the purposes of masking other malicious behavior. Additionally, writing malicious data to log files may target jobs, filters, reports, and other agents that process the logs in an asynchronous attack pattern. This pattern of attack is similar to "Log Injection-Tampering-Forging" except that in this case, the attack is targeting the logs of the web server and not the application.

    #### CAPEC-93: Log Injection-Tampering-Forging

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/93.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/481.html)
  ...
  **ATTACK:** Proxy:Domain Fronting

  ### CAPEC-571: Block Logging to Central Repository

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/571.html)

  **ATTACK:** Impair Defenses: Disable Cloud Logs, Impair Defenses: Disable Windows Event Logging, Impair Defenses: Impair Command History Logging, Impair Defenses: Indicator Blocking

  ### CAPEC-700: Network Boundary Bridging

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/700.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/165.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/73.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/572.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/655.html)

    **ATTACK:** Obfuscated Files or Information:Binary padding

  ### CAPEC-635: Alternative Execution Due to Deceptive Filenames

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/635.html)
  ...
  **ATTACK:** Masquerading: Double File Extension

  **Child Attack Patterns:**

    #### CAPEC-11: Cause Web Server Misclassification

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/11.html)
    ...
    **ATTACK:** Masquerading: Space after Filename
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/649.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/636.html)

  Files on various operating systems can have a complex format which allows for the storage of other data, in addition to its contents. Often this is metadata about the file, such as a cached thumbnail for an image file. Unless utilities are invoked in a particular way, this data is not visible during the normal use of the file. It is possible for an attacker to store malicious data or code using these facilities, which would be difficult to discover.

  **ATTACK:** Data Obfuscation: Steganography, Obfuscated Files or Information: Compile After Delivery, Obfuscated Files or Information: Steganography, Signed Binary Proxy Execution: Compiled HTML File, Template Injection

  **Child Attack Patterns:**

    #### CAPEC-35: Leverage Executable Code in Non-Executable Files

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/35.html)

    An attack of this type exploits a system's trust in configuration and resource files. When the executable loads the resource (such as an image file or configuration file) the attacker has modified the file to either execute malicious code directly or manipulate the target process (e.g. application server) to execute based on the malicious configuration parameters. Since systems are increasingly interrelated mashing up resources from local and remote sources the possibility of this attack occurring is high.

    **ATTACK:** Hide Artifacts: Resource Forking, Obfuscated Files or Information: HTML Smuggling, Obfuscated Files or Information: Embedded Payloads

    #### CAPEC-168: Windows ::DATA Alternate Data Stream

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/168.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/169.html)

An adversary engages in probing and exploration activities to identify constituents and properties of the target.

**ATTACK:** Active Scanning, Browser Bookmark Discovery, Gather Victim Host Information

**Child Attack Patterns:**

  ### CAPEC-292: Host Discovery

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/292.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/285.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/294.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/295.html)
    ...
    **ATTACK:** System Time Discovery
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/296.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/297.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/298.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/299.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/612.html)

    In this attack scenario, the attacker passively listens for WiFi messages and logs the associated Media Access Control (MAC) addresses. These addresses are intended to be unique to each wireless device (although they can be configured and changed by software). Once the attacker is able to associate a MAC address with a particular user or set of users (for example, when attending a public event), the attacker can then scan for that MAC address to track that user in the future.

    #### CAPEC-613: WiFi SSID Tracking

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/613.html)

    In this attack scenario, the attacker passively listens for WiFi management frame messages containing the Service Set Identifier (SSID) for the WiFi network. These messages are frequently transmitted by WiFi access points (e.g., the retransmission device) as well as by clients that are accessing the network (e.g., the handset/mobile device). Once the attacker is able to associate an SSID with a particular user or set of users (for example, when attending a public event), the attacker can then scan for this SSID to track that user in the future.

    #### CAPEC-618: Cellular Broadcast Message Request

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/618.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/619.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/300.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/287.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/301.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/302.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/303.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/304.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/305.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/306.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/307.html)

    An adversary scans for RPC services listing on a Unix/Linux host.

    #### CAPEC-308: UDP Scan

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/308.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/309.html)
  ...
  **ATTACK:** Gather Victim Network Information, System Network Configuration Discovery, System Network Connections Discovery

  **Child Attack Patterns:**

    #### CAPEC-290: Enumerate Mail Exchange (MX) Records

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/290.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/291.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/293.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/643.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/497.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/149.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/529.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/573.html)
  ...
  **ATTACK:** Process Discovery
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/574.html)
  ...
  **ATTACK:** System Service Discovery
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/575.html)
  ...
  **ATTACK:** Account Discovery
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/576.html)
  ...
  **ATTACK:** Group Policy Discovery, Permission Groups Discovery

  ### CAPEC-577: Owner Footprinting

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/577.html)
  ...
  **ATTACK:** System Owner/User Discovery
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/580.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/85.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/581.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/646.html)
  ...
  **ATTACK:** Peripheral Device Discovery
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/694.html)

  **ATTACK:** System Language Discovery

## CAPEC-173: Action Spoofing

[Full definition on MITRE](https://capec.mitre.org/data/definitions/173.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/103.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/181.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/222.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/587.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/504.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/654.html)
    ...
    **ATTACK:** Abuse Elevation Control Mechanism: Elevated Execution with Prompt, Input Capture

  ### CAPEC-506: Tapjacking

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/506.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/175.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/251.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/252.html)

    The attacker loads and executes an arbitrary local PHP file on a target machine. The attacker could use this to try to load old versions of PHP files that have known vulnerabilities, to load PHP files that the attacker placed on the local machine during a prior attack, or to otherwise change the functionality of the targeted application in unexpected ways.

    #### CAPEC-640: Inclusion of Code in Existing Process

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/640.html)
    ...
    **ATTACK:** Hijack Execution Flow: Dynamic Linker Hijacking, Hijack Execution Flow: KernelCallbackTable, Reflective Code Loading, Server Software Component: Terminal Services DLL

    #### CAPEC-660: Root/Jailbreak Detection Evasion via Hooking

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/660.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/253.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/101.html)
    ...
    **WASC:** SSI Injection
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/193.html)

    In this pattern the adversary is able to load and execute arbitrary code remotely available from the application. This is usually accomplished through an insecurely configured PHP runtime environment and an improperly sanitized "include" or "require" call, which the user can then control to point to any web-accessible file. This allows adversaries to hijack the targeted application and force it to execute their own instructions.

    #### CAPEC-500: WebView Injection

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/500.html)

    An adversary, through a previously installed malicious application, injects code into the context of a web page displayed by a WebView component. Through the injected code, an adversary is able to manipulate the DOM tree and cookies of the page, expose sensitive information, and can launch attacks against the web application from within the web page.

## CAPEC-176: Configuration/Environment Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/176.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/75.html)

  Generally these are manually edited files that are not in the preview of the system administrators, any ability on the attackers' behalf to modify these files, for example in a CVS repository, gives unauthorized access directly to the application, the same as authorized users.

  ### CAPEC-203: Manipulate Registry Information

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/203.html)
  ...
  **ATTACK:** Modify Registry, Plist Modification

  **Child Attack Patterns:**

    #### CAPEC-51: Poison Web Service Registry

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/51.html)

    SOA and Web Services often use a registry to perform look up, get schema information, and metadata about services. A poisoned registry can redirect (think phishing for servers) the service requester to a malicious service provider, provide incorrect information in schema or metadata, and delete information about service provider interfaces.

    #### CAPEC-270: Modification of Registry Run Keys

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/270.html)
    ...
    **ATTACK:** Boot or Logon Autostart Execution: Active, Boot or Logon Autostart Execution: Registry Run Keys / Start Folder

    #### CAPEC-478: Modification of Windows Service Configuration

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/478.html)

    An adversary exploits a weakness in access control to modify the execution parameters of a Windows service. The goal of this attack is to execute a malicious binary in place of an existing service.

    **ATTACK:** Create or Modify System Process:Windows Service, Hijack Execution Flow:Service Registry Permissions Weakness

  ### CAPEC-271: Schema Poisoning

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/271.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/146.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/536.html)

  An attacker with access to data files and processes on a victim's system injects malicious data into critical operational data during configuration or recalibration, causing the victim's system to perform in a suboptimal manner that benefits the adversary.

  ### CAPEC-578: Disable Security Software

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/578.html)

  An adversary exploits a weakness in access control to disable security tools so that detection does not occur. This can take the form of killing processes, deleting registry keys so that tools do not start at run time, deleting log files, or other methods.

  **ATTACK:** Impair Defenses: Disable Cloud Logs, Impair Defenses: Disable Windows Event Logging, Impair Defenses: Disable or Modify Cloud Firewall, Impair Defenses: Disable or Modify System Firewall, Impair Defenses: Disable or Modify Tools, Impair Defenses: Safe Mode Boot, Modify Authentication Process: Multi-Factor Authentication

## CAPEC-184: Software Integrity Attack

[Full definition on MITRE](https://capec.mitre.org/data/definitions/184.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/185.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/186.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/187.html)
    ...
    **ATTACK:** Software Deployment Tools
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/533.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/614.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/657.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/669.html)

  **ATTACK:** Supply Chain Compromise: Compromise Software Supply Chain

## CAPEC-188: Reverse Engineering

[Full definition on MITRE](https://capec.mitre.org/data/definitions/188.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/167.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/37.html)

    An attacker examines a target system to find sensitive data that has been embedded within it. This information can reveal confidential contents, such as account numbers or individual keys/credentials that can be used as an intermediate step in a larger attack.

    **ATTACK:** Data from Local System, Unsecured Credentials: Private Keys

    #### CAPEC-190: Reverse Engineer an Executable to Expose Assumed Hidden Functionality

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/190.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/191.html)

    **ATTACK:** Unsecured Credentials:Credentials in files

    #### CAPEC-204: Lifting Sensitive Data Embedded in Cache

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/204.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/189.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/621.html)

    An attacker may intercept and log encrypted transmissions for the purpose of analyzing metadata such as packet timing and sizes. Although the actual data may be encrypted, this metadata may reveal valuable information to an attacker. Note that this attack is applicable to VOIP data as well as application data, especially for interactive apps that require precise timing and low-latency (e.g. thin-clients).

    #### CAPEC-622: Electromagnetic Side-Channel Attack

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/622.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/623.html)

    Compromising Emanations (CE) are defined as unintentional signals which an attacker may intercept and analyze to disclose the information processed by the targeted equipment. Commercial mobile devices and retransmission devices have displays, buttons, microchips, and radios that emit mechanical emissions in the form of sound or vibrations. Capturing these emissions can help an adversary understand what the device is doing.

## CAPEC-192: Protocol Analysis

[Full definition on MITRE](https://capec.mitre.org/data/definitions/192.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/97.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/463.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/608.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/212.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/2.html)
  ...
  **ATTACK:** Account Access Removal
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/48.html)

  This attack relies on client side code to access local files and resources instead of URLs. When the client browser is expecting a URL string, but instead receives a request for a local file, that execution is likely to occur in the browser process space with the browser's authority to local files. The attacker can send the results of this request to the local files out to a site that they control. This attack may be used to steal sensitive authentication data (either local or remote), or to gain system profile information to launch further attacks.

  ### CAPEC-50: Password Recovery Exploitation

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/50.html)

  An attacker may take advantage of the application feature to help users recover their forgotten passwords in order to gain access into the system with the same privileges as the original user. Generally password recovery schemes tend to be weak and insecure.

  ### CAPEC-111: JSON Hijacking (aka JavaScript Hijacking)

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/111.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/620.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/606.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/682.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/216.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/12.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/217.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/224.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/312.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/317.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/318.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/319.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/320.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/321.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/322.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/323.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/324.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/325.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/326.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/327.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/328.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/329.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/330.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/331.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/332.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/313.html)
  ...
  **ATTACK:** System Information Discovery
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/541.html)

  An adversary engages in fingerprinting activities to determine the type or version of an application installed on a remote target.

  **ATTACK:** Gather Victim Host Information: Software

  **Child Attack Patterns:**

    #### CAPEC-170: Web Application Fingerprinting

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/170.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/310.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/472.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/227.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/469.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/233.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/30.html)
  ...
  **ATTACK:** Process Injection: Thread Execution Hijacking

  ### CAPEC-68: Subvert Code-signing Facilities

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/68.html)
  ...
  **ATTACK:** Subvert Trust Controls: Code Signing

  ### CAPEC-69: Target Programs with Elevated Privileges

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/69.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/104.html)

  An attacker is able to cause a victim to load content into their web-browser that bypasses security zone controls and gain access to increased privileges to execute scripting code or other web objects such as unsigned ActiveX controls or applets. This is a privilege elevation attack targeted at zone-based web-browser security.

  ### CAPEC-234: Hijacking a privileged process

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/234.html)

  An adversary gains control of a process that is assigned elevated privileges in order to execute arbitrary code with those privileges. Some processes are assigned elevated privileges on an operating system, usually through association with a particular user, group, or role. If an attacker can hijack this process, they will be able to assume its level of privilege in order to execute their own code.

## CAPEC-240: Resource Injection

[Full definition on MITRE](https://capec.mitre.org/data/definitions/240.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/610.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/242.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/19.html)

  An adversary leverages the capability to execute their own script by embedding it within other scripts that the target software is likely to execute due to programs' vulnerabilities that are brought on by allowing remote hosts to execute scripts.

  **ATTACK:** Event Triggered Execution:.bash_profile and .bashrc, Event Triggered Execution: Installer Packages, Obfuscated Files or Information: Embedded Payloads

  ### CAPEC-23: File Content Injection

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/23.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/41.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/63.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/588.html)
    ...
    **OWASP Attacks:** Reflected DOM Injection
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/591.html)
    ...
    **Child Attack Patterns:**
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/18.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/32.html)

      An adversary embeds malicious script code in the parameters of an HTTP query string and convinces a victim to submit the HTTP request that contains the query string to a vulnerable web application. The web application then procedes to use the values parameters without properly validation them first and generates the HTML code that will be executed by the victim's browser.

      ##### CAPEC-86: XSS Through HTTP Headers

      [Full definition on MITRE](https://capec.mitre.org/data/definitions/86.html)

      An adversary exploits web applications that generate web content, such as links in a HTML page, based on unvalidated or improperly validated data submitted by other actors. XSS in HTTP Headers attacks target the HTTP headers which are hidden from most users and may not be validated by web applications.

      ##### CAPEC-198: XSS Targeting Error Pages

      [Full definition on MITRE](https://capec.mitre.org/data/definitions/198.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/199.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/243.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/244.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/245.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/247.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/592.html)
    ...
    **Child Attack Patterns:**
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/209.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/468.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/248.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/40.html)

  This attack exploits terminal devices that allow themselves to be written to by other users. The attacker sends command strings to the target terminal device hoping that the target user will hit enter and thereby execute the malicious command with their privileges. The attacker can send the results (such as copying /etc/passwd) to a known directory and collect once the attack has succeeded.

  ### CAPEC-66: SQL Injection

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/66.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/7.html)
    ...
    **OWASP Attacks:** Blind SQL Injection
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/108.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/109.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/110.html)

    An attacker modifies the parameters of the SOAP message that is sent from the service consumer to the service provider to initiate a SQL injection attack. On the service provider side, the SOAP message is parsed and parameters are not properly validated before being used to access a database in a way that does not use parameter binding, thus enabling the attacker to control the structure of the executed SQL query. This pattern describes a SQL injection attack with the delivery mechanism being a SOAP message.

    #### CAPEC-470: Expanding Control over the Operating System from the Database

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/470.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/88.html)
  ...
  **WASC:** OS Commanding
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/136.html)
  ...
  **WASC:** LDAP Injection
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/183.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/250.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/83.html)

    An attacker can craft special user-controllable input consisting of XPath expressions to inject the XML database and bypass authentication or glean information that they normally would not be able to. XPath Injection enables an attacker to talk directly to the XML database, thus bypassing the application completely. XPath Injection results from the failure of an application to properly sanitize input used as part of dynamic XPath expressions used to query an XML database.

    **OWASP Attacks:** Blind XPath Injection, XPATH Injection
    **WASC:** XPath Injection

    #### CAPEC-84: XQuery Injection

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/84.html)
    ...
    **WASC:** XQuery Injection
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/228.html)

    An attacker injects malicious content into an application's DTD in an attempt to produce a negative technical impact. DTDs are used to describe how XML documents are processed. Certain malformed DTDs (for example, those with excessive entity expansion as described in CAPEC 197) can cause the XML parsers that process the DTDs to consume excessive resources resulting in resource depletion.

  ### CAPEC-676: NoSQL Injection

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/676.html)

## CAPEC-272: Protocol Manipulation

[Full definition on MITRE](https://capec.mitre.org/data/definitions/272.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/90.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/220.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/5.html)

    #### CAPEC-33: HTTP Request Smuggling

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/33.html)

    **WASC:** HTTP Request Smuggling

    #### CAPEC-34: HTTP Response Splitting

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/34.html)

    **WASC:** HTTP Response Splitting

    #### CAPEC-105: HTTP Request Splitting

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/105.html)

    **WASC:** HTTP Request Splitting

    #### CAPEC-273: HTTP Response Smuggling

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/273.html)

    **WASC:** HTTP Response Smuggling

    #### CAPEC-274: HTTP Verb Tampering

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/274.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/276.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/665.html)

    **ATTACK:** Exploitation for Defensive Evasion, Modify Authentication Process, Pre-OS Boot: Component Firmware

  ### CAPEC-277: Data Interchange Protocol Manipulation

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/277.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/278.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/279.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/390.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/391.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/392.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/393.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/394.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/395.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/397.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/398.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/399.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/400.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/626.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/410.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/416.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/407.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/383.html)
    ...
    **ATTACK:** Input Capture: Credential API Hooking
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/412.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/413.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/414.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/415.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/417.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/418.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/420.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/421.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/422.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/423.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/424.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/425.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/426.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/427.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/428.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/429.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/433.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/434.html)

    #### CAPEC-435: Target Influence via Instant Rapport

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/435.html)

## CAPEC-438: Modification During Manufacture

[Full definition on MITRE](https://capec.mitre.org/data/definitions/438.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/444.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/206.html)
    ...
    **ATTACK:** Subvert Trust Controls:Code Signing
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/443.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain, Supply Chain Compromise: Compromise Software Supply Chain

    #### CAPEC-445: Malicious Logic Insertion into Product Software via Configuration Management Manipulation

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/445.html)

    **ATTACK:** Supply Chain Compromise: Compromise Software Dependencies and Development Tools

    #### CAPEC-446: Malicious Logic Insertion into Product via Inclusion of Third-Party Component

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/446.html)

    **ATTACK:** Supply Chain Compromise

    #### CAPEC-511: Infiltration of Software Development Environment

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/511.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Software Dependencies and Development Tools
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/516.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/520.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/532.html)
    ...
    **ATTACK:** Firmware Corruption, Pre-OS Boot:System Firmware

    #### CAPEC-537: Infiltration of Hardware Development Environment

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/537.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/538.html)

    Adversaries implant malicious code in open source software (OSS) libraries to have it widely distributed, as OSS is commonly downloaded by developers and other users to incorporate into software development projects. The adversary can have a particular system in mind to target, or the implantation can be the first stage of follow-on attacks on many systems.

    **ATTACK:** Supply Chain Compromise: Software Dependencies and Development Tools

    #### CAPEC-539: ASIC With Malicious Functionality

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/539.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/670.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Software Dependencies and Development Tools, Trusted Developer Utilities Proxy Execution

    #### CAPEC-672: Malicious Code Implanted During Chip Programming

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/672.html)

    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain

    #### CAPEC-673: Developer Signing Maliciously Altered Software

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/673.html)

    **ATTACK:** Supply Chain Compromise: Compromise Software Supply Chain

    #### CAPEC-678: System Build Data Maliciously Altered

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/678.html)

    **ATTACK:** Supply Chain Compromise: Compromise Software Supply Chain

  ### CAPEC-447: Design Alteration

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/447.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/517.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/518.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/519.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/521.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/671.html)
    ...
    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/674.html)

    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain

## CAPEC-439: Manipulation During Distribution

[Full definition on MITRE](https://capec.mitre.org/data/definitions/439.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/522.html)
  ...
  **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/523.html)
  ...
  **ATTACK:** Supply Chain Compromise: Compromise Software Supply Chain
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/524.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/440.html)
...
**ATTACK:** Hardware Additions, Supply Chain Compromise: Compromise Hardware Supply Chain

**Child Attack Patterns:**

  ### CAPEC-401: Physically Hacking Hardware

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/401.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/402.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/534.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/531.html)
    ...
    **Child Attack Patterns:**
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/530.html)
      ...
      [Full definition on MITRE](https://capec.mitre.org/data/definitions/535.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/677.html)

    **ATTACK:** Supply Chain Compromise: Compromise Hardware Supply Chain

## CAPEC-441: Malicious Logic Insertion

[Full definition on MITRE](https://capec.mitre.org/data/definitions/441.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/442.html)

  An adversary adds malicious logic, often in the form of a computer virus, to otherwise benign software. This logic is often hidden from the user of the software and works behind the scenes to achieve negative impacts. Many times, the malicious logic is inserted into empty space between legitimate code, and is then called when the software is executed. This pattern of attack focuses on software already fielded and used in operation as opposed to software that is still under development and part of the supply chain.

  **ATTACK:** Supply Chain Compromise: Compromise Software Dependencies and Development Tools, Supply Chain Compromise: Compromise Software Supply Chain

  **Child Attack Patterns:**

    #### CAPEC-448: Embed Virus into DLL

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/448.html)

    An adversary tampers with a DLL and embeds a computer virus into gaps between legitimate machine instructions. These gaps may be the result of compiler optimizations that pad memory blocks for performance gains. The embedded virus then attempts to infect any machine which interfaces with the product, and possibly steal private data or eavesdrop.

    **ATTACK:** Obfuscated Files or Information: Embedded Payloads

  ### CAPEC-452: Infected Hardware

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/452.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/638.html)
    ...
    **ATTACK:** Pre-OS Boot:Component Firmware

  ### CAPEC-456: Infected Memory

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/456.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/457.html)
    ...
    **ATTACK:** Communication Through Removable Media, Replication Through Removable Media

    #### CAPEC-458: Flash Memory Attacks

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/458.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/507.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/548.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/549.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/542.html)
  ...
  **ATTACK:** Develop Capabilities: Malware, Obfuscated Files or Information

  **Child Attack Patterns:**

    #### CAPEC-550: Install New Service

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/550.html)
    ...
    **ATTACK:** Create or Modify System Process
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/551.html)
    ...
    **ATTACK:** Create or Modify System Process
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/552.html)

    An adversary exploits a weakness in authentication to install malware that alters the functionality and information provide by targeted operating system API calls. Often referred to as rootkits, it is often used to hide the presence of programs, files, network connections, services, drivers, and other system components.

    **ATTACK:** Boot or Logon Autostart Execution:Kernel Modules and Extensions, Pre-OS Boot:Bootkit, Rootkit

    #### CAPEC-556: Replace File Extension Handlers

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/556.html)
    ...
    **ATTACK:** Event Triggered Execution:Change Default File Association
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/558.html)

    An adversary exploits weaknesses in privilege management or access control to replace a trusted executable with a malicious version and enable the execution of malware when that trusted executable is called.

    **ATTACK:** Event Triggered Execution: Accessibility Features, Server Software Component: Terminal Services DLL

    #### CAPEC-564: Run Software at Logon

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/564.html)

    Operating system allows logon scripts to be run whenever a specific user or users logon to a system. If adversaries can access these scripts, they may insert additional code into the logon script. This code can allow them to maintain persistence or move laterally within an enclave because it is executed every time the affected user or users logon to a computer. Modifying logon scripts can effectively bypass workstation and enclave firewalls. Depending on the access configuration of the logon scripts, either local credentials or a remote administrative account may be necessary.

    **ATTACK:** Boot or Logon Autostart Execution, Boot or Logon Initialization Scripts, Create or Modify System Process: Launch Agent, Create or Modify System Process: Launch Daemon

    #### CAPEC-579: Replace Winlogon Helper DLL

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/579.html)
    ...
    **ATTACK:** Boot or Logon Autostart Execution: Winlogon helper DLL
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/698.html)

    **ATTACK:** Browser Extensions, Server Software Component: IIS Components

## CAPEC-554: Functionality Bypass

[Full definition on MITRE](https://capec.mitre.org/data/definitions/554.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/179.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/464.html)
  ...
  **ATTACK:** Forge Web Credentials: Web Cookies

  ### CAPEC-465: Transparent Proxy Abuse

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/465.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/560.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/555.html)

  This pattern of attack involves an adversary that uses stolen credentials to leverage remote services such as RDP, telnet, SSH, and VNC to log into a system. Once access is gained, any number of malicious activities could be performed.

  **ATTACK:** Email Collection:Remote Email Collection, External Remote Services, Remote Services

  ### CAPEC-600: Credential Stuffing

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/600.html)
  ...
  **OWASP Attacks:** Credential stuffing
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/652.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/509.html)
    ...
    **ATTACK:** Steal or Forge Kerberos Tickets:Kerberoasting
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/645.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/653.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/561.html)
    ...
    **ATTACK:** Remote Services:SMB/Windows Admin Shares
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/644.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/586.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/594.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/595.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/596.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/607.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/547.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/582.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/583.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/584.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/585.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/601.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/559.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/604.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/605.html)
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/603.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/96.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/589.html)
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/590.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/624.html)
...
**Child Attack Patterns:**
  ...
  [Full definition on MITRE](https://capec.mitre.org/data/definitions/625.html)
...
[Full definition on MITRE](https://capec.mitre.org/data/definitions/690.html)

**Child Attack Patterns:**

  ### CAPEC-691: Spoof Open-Source Software Metadata

  [Full definition on MITRE](https://capec.mitre.org/data/definitions/691.html)
  ...
  **Child Attack Patterns:**
    ...
    [Full definition on MITRE](https://capec.mitre.org/data/definitions/692.html)

    #### CAPEC-693: StarJacking

    [Full definition on MITRE](https://capec.mitre.org/data/definitions/693.html)
