...
<div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 24px; margin: 24px 0;">
  <div style="flex: 0 0 auto; max-width: 320px; text-align: center;">
  ...
  <div style="flex: 1 1 320px; min-width: 280px; max-width: 680px;">
    <h1 style="margin-top: 0;">About Wayne</h1>
    <p style="margin-bottom: 16px; font-size: 1.05rem; line-height: 1.7;">I’m a software engineering and testing professional with decades of experience building teams, writing books, and helping organizations improve quality and delivery.</p>
    <p style="margin-bottom: 0; font-size: 1.05rem; line-height: 1.7;">This page gives you the full story of my background, work, and writing, while still keeping the structure easy to scan and read.</p>
  </div>
</div>
